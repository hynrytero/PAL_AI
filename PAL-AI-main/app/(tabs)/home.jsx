      ...
      >
        <View className="w-full h-auto px-7 pt-12 pb-4 rounded-b-[30px] flex-col items-center">
          ...
          <View className="flex-row mx-7 mt-5 bg-[#D3E9FF]  w-full rounded-[5px] p-[10px] justify-between items-center">
            <View className="bg-[#5284B7] w-[110px] rounded-[5px] justify-center items-center p-3 overflow-hidden">
              <Image
                source={images.circlesun}
                className="absolute bottom-[-50] right-[-30]"
              />
              <Text className="text-white font-pmedium text-md">Today</Text>
              <Text className="font-pregular text-[40px] text-white">29°</Text>
            </View>
            <View className="bg-[#7BAFE3] w-[110px] rounded-[5px] justify-center items-center p-3 overflow-hidden">
              <Image
                source={images.circlesun}
                className="absolute bottom-[-50] right-[-30]"
              />
              <Text className="text-white font-pmedium text-md">Tomorrow</Text>
              <Text className="font-pregular text-[40px] text-white">28°</Text>
            </View>
            <View className="bg-[#7BAFE3] w-[110px] rounded-[5px] justify-center items-center p-3 overflow-hidden">
              <Image
                source={images.circlesun}
              ...
              <Text className="font-pregular text-[40px] text-white">30°</Text>
            </View>
          </View>
        </View>
      </ImageBackground>
