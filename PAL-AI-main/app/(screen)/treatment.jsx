    ...
    <View className="flex-1 h-full w-full pt-7">
      <SafeAreaView className="w-full h-full">
        <ScrollView className="px-7">
          ...
          <Text className="font-pregular text-md leading-6 mb-5">
            1. Inspect the field for symptoms such as stunted growth, yellow or
            orange discoloration, and reduced tillers. {"\n"}2. Apply
            ...
            3. Use the recommended dosage specified on the product label.
            Typically, 200-300 ml per hectare mixed with sufficient water.{" "}
            {"\n"}4. Spray in the early morning or late afternoon for effective
            absorption and to avoid evaporation. Avoid applying the treatment
